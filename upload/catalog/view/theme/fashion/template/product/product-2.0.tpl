    ...
    <?php } ?>
        ...
        <div class="<?php echo $class; ?>">
          ...
          <div id="product">
            ...
            <div class="form-group product-btns">
              ...
              <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary add-cart"><i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;<?php echo $button_cart; ?></button>
      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?> product-layout">
          <div class="product-thumb white-bg transition">
            ...
            <div class="caption">
              ...
              <div class="pull-right hidden-btn-blk">
                ...
                <button type="button" data-toggle="tooltip" title="Add to Cart" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><span class="hidden-xs hidden-sm hidden-md"><?php //echo $button_cart; ?></span> <i class="fa fa-shopping-cart"></i></button>
              </div>
...
<script src="catalog/view/theme/shopify/javascript/elevatezoom/jquery.elevatezoom.js" type="text/javascript"></script>
<script src="catalog/view/theme/shopify/javascript/fancybox/jquery.fancybox.js" type="text/javascript"></script>
<link href="catalog/view/theme/shopify/javascript/fancybox/jquery.fancybox.css" type="text/css" rel="stylesheet" media="screen" />
