...
<div class="block-title text-center margin-bottom-50">
  ...
  <span class="text-uppercase">Our Special Products</span>
</div>
<div class="module-slider special owl-carousel">
  ...
  <div class="product-layout">
    <div class="product-thumb transition">
      ...
      <div class="pull-right block-btn-blk">
        ...
        <button type="button" data-toggle="tooltip" title="Add to Cart"  onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php //echo $button_cart; ?></span></button>
      </div>
